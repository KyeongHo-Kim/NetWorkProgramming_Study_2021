/*
    ------------------- Client -------------------
    socket option을 linger 설정 time 0으로 셋팅
*/
...
int main()
{
	...
	ling.l_onoff = 1;
	ling.l_linger = 0;
	if (setsockopt(tcpSocket, SOL_SOCKET, SO_LINGER, (char *)&ling, sizeof(ling)) == SOCKET_ERROR)
	{
		Err_Display("setsockopt_LINGER()");
		return -1;
	}
...
/*
    ...
    rst signal 호출된다 따라서 SOCKET_ERROR로 종료된다.
*/
